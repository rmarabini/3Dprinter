...
// Spline Size
spline_type = 10; // [1:Hitec C1-24T, 2:Hitec D1-15T, 3:Futaba 1F-15, 4:Futaba 2F-21T (9g?), 5:Futaba 3F-25T, 6:Actobotics Horn(Hitec), 7:Actobotics Horn(Futaba), 8:Tetrix Horn(Hitec), 9:Tetrix Horn(Futaba) ]

arm_length = 20.0;

arm_count = 2; // [1,2,3,4,5,6,7,8]

arm_screw_diameter = 3.0;
...
FUTABA_3F_SPLINE_ROB = [
                     [5.4, 4.5, 7.95, 3, base_thickness],
                     [25, 0.3, 0.7, 0.1]
                   ];
module servo_futaba_3f_rob(length, count) {
  servo_arm(FUTABA_3F_SPLINE_ROB, [length, count]);
}
//------------------------------------------------
...
module print_part() {
	...
	} else if (spline_type  == 10) {
        translate([0, 0, -2])
		servo_futaba_3f_rob(2, 8);
	}
}

//translate([00,0,0]) servo_futaba_1f(10, 1);
//translate([10,0,0]) servo_futaba_2f(10, 1);
//translate([0,-0,0]) servo_futaba_3f(20, 4);
//translate([20,0,0]) servo_hitec_c1 (30, 1);
//translate([32,0,0]) servo_hitec_d1 (40, 2);


rotate([90,0,0])
translate([12.255, -0.95 -2, 10.875])
import("/home/roberto/ssd/3Dprinter/Rubik2/files/gear_Left_update.stl");